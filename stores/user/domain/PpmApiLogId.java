...
/**
 * PpmApiLogId entity. @author MyEclipse Persistence Tools
 */

@SuppressWarnings("serial")
public class PpmApiLogId implements java.io.Serializable {
	...
	/** full constructor */
	public PpmApiLogId(Timestamp requesttime, String factorid,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PpmApiLogId))
			return false;
		PpmApiLogId castOther = (PpmApiLogId) other;
