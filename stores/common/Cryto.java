...
public class Cryto {
	...
	static Logger logger = Logger.getLogger(Cryto.class);//日志对象
	private static String algorithm_DESede = "DESede";//算法
	private static String default_charset = "UTF-8";//编码方式
